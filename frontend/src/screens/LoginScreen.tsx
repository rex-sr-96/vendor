    ...
    <div className="w-full flex flex-col justify-between select-none">
      ...
      <div className="w-full">
        <div className="flex flex-col items-center text-center mb-7">
          ...
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#F94001] to-[#E8591A] flex items-center justify-center shadow-lg shadow-[#F94001]/25 mb-4">
            <span className="text-white font-black text-xl tracking-tighter">TT</span>
          </div>

          {/* Owner Center Tag */}
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#F94001]/10 border border-[#F94001]/20 mb-3">
            <span className="w-1.5 h-1.5 rounded-full bg-[#F94001]" />
            <span className="text-[11px] font-bold text-[#F94001] uppercase tracking-wider">Owner Control Center</span>
          </div>

          <h1 className="text-[25px] font-bold text-[#021526] tracking-tight">
            Welcome back
          </h1>
          <p className="text-[13.5px] text-[#5F6368] mt-1.5 leading-normal max-w-[300px]">
        ...
        <form onSubmit={handleContinue} className="space-y-4">
          <div>
            ...
            <div className="relative flex items-center bg-[#F9F9F7] border border-[#E5E7EB] rounded-2xl focus-within:border-[#F94001] focus-within:ring-4 focus-within:ring-[#F94001]/10 focus-within:bg-white transition-all overflow-hidden">
              <div className="flex items-center gap-1.5 px-3.5 py-3.5 border-r border-[#E5E7EB] bg-[#F2F1ED]/50 select-none">
                ...
                <span className="text-[14px] font-bold text-[#021526]">+91</span>
              </div>
              <input
                id="mobile-input"
                type="tel"
          ...
          <div className="pt-2 space-y-3">
            ...
            <p className="text-[11.5px] text-center text-[#5F6368] leading-normal px-2">
