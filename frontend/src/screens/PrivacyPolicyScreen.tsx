      ...
      <div className="flex items-center justify-between pb-2 border-b border-[#E8E6E1]/70">
        <div className="flex items-center gap-3">
          <button
            ...
            className="md:hidden w-10 h-10 rounded-2xl bg-white border border-[#E8E6E1] flex items-center justify-center text-[#171717] hover:bg-[#F7F7F5] shadow-2xs active-press transition-colors cursor-pointer"
            aria-label="Back"
          >
            <ChevronLeft className="w-5 h-5 stroke-[2.2]" />
          </button>
          <div>
            <h1 className="text-[22px] font-black text-[#171717] tracking-tight">
              Privacy Policy
            </h1>
        ...
        <button
          ...
          className="h-9 px-3.5 rounded-xl bg-white hover:bg-[#F7F7F5] border border-[#E8E6E1] text-[#171717] text-[12px] font-bold flex items-center gap-1.5 shadow-2xs active-press cursor-pointer transition-colors"
        >
          <Printer className="w-3.5 h-3.5 text-[#777570]" />
          <span>Print Policy</span>
        </button>
      </div>

      {/* Rich Text Legal Document Container */}
      <div className="bg-white rounded-3xl p-6 sm:p-10 border border-[#E8E6E1] shadow-2xs space-y-8 text-[#262524] font-normal leading-relaxed">
        {/* Document Header */}
        ...
        <section className="space-y-3">
          <h3 className="text-[17px] font-black text-[#171717] tracking-tight flex items-center gap-2">
            <span className="text-[#FF6B2C]">1.</span> Information We Collect
          </h3>
          <p className="text-[13.5px] text-[#55534E]">
          ...
          <ul className="list-disc pl-6 space-y-2 text-[13px] text-[#55534E]">
            <li>
              <strong className="text-[#171717]">Venue & Business Credentials:</strong> Facility business name, registered address, GSTIN/PAN (where applicable), bank settlement account information, and merchant point-of-contact details.
            </li>
            <li>
              <strong className="text-[#171717]">Staff & Access Logs:</strong> Manager profile logins, team member role designations (Cashier, Groundkeeper, Referee), and granular security audit logs.
            </li>
            <li>
              <strong className="text-[#171717]">Customer Booking Information:</strong> Player name, phone number, booked sports turf, slot timestamps, payment mode (UPI, Cash, or Card), and automated hold timers.
            </li>
            <li>
              <strong className="text-[#171717]">Transaction Metadata:</strong> IMPS reference numbers, UPI transaction identifiers, payout settlement timestamps, and dispute records.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          <h3 className="text-[17px] font-black text-[#171717] tracking-tight flex items-center gap-2">
            <span className="text-[#FF6B2C]">2.</span> How We Use Your Data
          </h3>
          <p className="text-[13.5px] text-[#55534E]">
            Information processed through your console is restricted solely to sports venue operations:
          </p>
          <div className="space-y-2 pl-4 border-l-2 border-[#E8E6E1] text-[13px] text-[#55534E]">
        ...
        <section className="space-y-3">
          <h3 className="text-[17px] font-black text-[#171717] tracking-tight flex items-center gap-2">
            <span className="text-[#FF6B2C]">3.</span> Data Protection & 256-Bit TLS Security
          </h3>
          <p className="text-[13.5px] text-[#55534E]">
        ...
        <section className="space-y-3">
          <h3 className="text-[17px] font-black text-[#171717] tracking-tight flex items-center gap-2">
            <span className="text-[#FF6B2C]">4.</span> Strict Third-Party Data Sharing Policy
          </h3>
          <p className="text-[13.5px] text-[#55534E]">
          ...
          <ul className="list-disc pl-6 space-y-1.5 text-[13px] text-[#55534E]">
        ...
        <section className="space-y-3">
          <h3 className="text-[17px] font-black text-[#171717] tracking-tight flex items-center gap-2">
            <span className="text-[#FF6B2C]">5.</span> Data Retention & Venue Operator Rights
          </h3>
          <p className="text-[13.5px] text-[#55534E]">
        ...
        <div className="bg-[#FAF9F6] rounded-2xl p-5 border border-[#E8E6E1] space-y-3">
          <div className="flex items-center gap-2 text-[14px] font-black text-[#171717]">
            <Lock className="w-4 h-4 text-[#2FA66A]" />
            <span>Data Protection Officer & Privacy Grievances</span>
          </div>
          <p className="text-[12.5px] text-[#777570] leading-relaxed">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-1 text-[12px] font-bold text-[#171717]">
            <div className="flex items-center gap-2 bg-white px-3 py-1.5 rounded-xl border border-[#E8E6E1]">
              <Mail className="w-3.5 h-3.5 text-[#FF6B2C]" />
              <span>privacy@turftown.app</span>
            </div>
            <div className="flex items-center gap-2 bg-white px-3 py-1.5 rounded-xl border border-[#E8E6E1]">
              <Phone className="w-3.5 h-3.5 text-[#2FA66A]" />
