      ...
      <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center p-0 md:p-4 bg-black/60 backdrop-blur-xs select-none">
        ...
        >
          ...
          <div className="flex items-center justify-between pb-2.5 border-b border-[#F3F4F4]">
            <div>
              <h2 className="text-[17px] font-bold text-[#021526]">Dynamic UPI QR</h2>
              <p className="text-[10.5px] text-[#5F6368]">Direct Counter Scan (GPay / PhonePe / Paytm)</p>
            </div>
            <button
              onClick={handleClose}
          ...
          {!paymentReceived ? (
            ...
            <div className="text-center py-2 space-y-2.5">
              <div className="bg-[#F3F4F4] p-2.5 rounded-2xl border border-[#E5E7EB] text-[11.5px] space-y-1">
                ...
                <div className="flex justify-between items-baseline pt-1 border-t border-[#E5E7EB] font-bold text-[#021526]">
                  <span>Total Payable:</span>
                  <span className="text-[16px] font-black text-[#021526]">₹{fin.totalCustomerPayable.toLocaleString('en-IN')}</span>
                </div>
              </div>
