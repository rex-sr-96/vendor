...
export const DateMonthPickerSheet: React.FC<DateMonthPickerSheetProps> = ({
  ...
  const accentColorClass =
    themeColor === 'green'
      ...
      : themeColor === 'black'
      ? 'bg-[#021526] text-white hover:bg-[#333333]'
  ...
  const accentBgLightClass =
    themeColor === 'green'
      ...
      : themeColor === 'black'
      ? 'bg-[#021526]/10 text-[#021526] border-[#021526]/30'
    ...
    <AnimatePresence>
      <div className="absolute inset-0 z-50 flex items-end justify-center bg-black/60 backdrop-blur-xs">
        ...
        <motion.div
          ...
          className="relative w-full bg-white rounded-t-[32px] p-5 pb-7 shadow-2xl border-t border-[#E5E7EB] max-h-[92vh] overflow-y-auto"
        >
          {/* Sheet Grab Handle */}
          ...
          {showModeTabs && (
            <div className="pt-3 pb-2">
              <div className="flex items-center bg-[#F3F4F4] p-1 rounded-2xl">
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-xl text-[11.5px] font-bold shrink-0 border transition-all active-press cursor-pointer ${
                activeSelection === 'Today' || activeSelection === '28 Aug 2026'
                  ? accentColorClass
                  : 'bg-[#F3F4F4] border-[#E5E7EB] text-[#021526] hover:bg-[#EBE9E3]'
              }`}
            >
              Today (28 Aug)
            </button>
            ...
            <div className="bg-[#F3F4F4] rounded-2xl p-4 border border-[#E5E7EB] space-y-3">
              ...
              <div className="flex items-center justify-between px-1">
                <button
                  ...
                  className="w-8 h-8 rounded-xl bg-white border border-[#E5E7EB] flex items-center justify-center text-[#021526] hover:bg-[#F3F4F4] active-press cursor-pointer shadow-2xs"
                >
                  <ChevronLeft className="w-4 h-4" />
                </button>
                <div className="text-center">
                  <span className="text-[15px] font-extrabold text-[#021526]">
              ...
              <div className="grid grid-cols-7 gap-1 text-center">
                {DAYS_OF_WEEK.map((d) => (
                  <span key={d} className="text-[11px] font-bold text-[#5F6368] py-0.5">
                    {d}
                  </span>
                ))}
              </div>
                    ...
                    <button
                      ...
                      className={`h-9 w-full rounded-xl flex flex-col items-center justify-center text-[12.5px] font-bold transition-all relative cursor-pointer active-press border ${
                        isSelected
                          ...
                          : isToday
                          ? 'bg-white border-[#F94001]/50 text-[#F94001] shadow-2xs'
                          : 'bg-white border-[#E5E7EB] text-[#021526] hover:bg-[#EBE9E3]'
                      }`}
                    >
                      <span>{day}</span>
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected ? (
                      ...
                      <span className="text-[11px] font-semibold text-[#5F6368]">Select</span>
                    )}
                  </div>
                );
              })}
          ...
          {activeTab === 'month' && (
            /* Month Picker Grid */
            <div className="bg-[#F3F4F4] rounded-2xl p-4 border border-[#E5E7EB] space-y-3.5">
              {/* Year Switcher */}
              <div className="flex items-center justify-between px-1">
                <button
                  onClick={() => {
                    ...
                    <button
                      ...
                      className={`py-3 px-2 rounded-2xl text-center transition-all cursor-pointer active-press border flex flex-col items-center justify-center relative ${
                        isSelected
                          ? `${accentColorClass} border-transparent shadow-xs font-extrabold`
                          : isCurrentMonth
                          ? 'bg-white border-[#16A34A]/40 text-[#021526] font-extrabold shadow-2xs'
                          : 'bg-white border-[#E5E7EB] text-[#021526] hover:bg-[#EBE9E3]'
                      }`}
                    >
          ...
          <div className="flex items-center justify-between gap-2 pt-4">
            <button
              ...
              className="flex-1 py-2.5 rounded-2xl bg-[#F3F4F4] text-[#021526] text-[12.5px] font-bold hover:bg-[#E5E7EB] active-press cursor-pointer flex items-center justify-center gap-1.5"
            >
