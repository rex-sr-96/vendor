      ...
      <div className="bg-white rounded-2xl p-3.5 border border-[#E5E7EB] shadow-xs space-y-3">
        ...
        <div className="space-y-1.5 text-[13px]">
          <div className="flex justify-between text-[#5F6368]">
            ...
            <span className="font-bold text-[#021526]">₹{b.totalAmount.toLocaleString('en-IN')}</span>
          </div>
          <div className="flex justify-between text-[#5F6368]">
          ...
          <div className="pt-1.5 border-t border-[#F3F4F4] flex justify-between items-baseline">
            <span className="font-bold text-[#021526]">Balance Amount</span>
            <span
        ...
        {!isFullyPaid && (
          <div className="space-y-2 pt-1">
            <button
              ...
              className="w-full h-11 rounded-xl bg-[#F94001] text-white font-bold text-[13px] flex items-center justify-center gap-1.5 shadow-xs hover:bg-[#D93600] active-press transition-all cursor-pointer"
            >
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="h-10 rounded-xl bg-white border border-[#E5E7EB] text-[#021526] font-bold text-[12px] flex items-center justify-center gap-1.5 hover:border-[#021526] active-press transition-all cursor-pointer"
              >
                <QrCode className="w-3.5 h-3.5 text-[#5F6368]" />
                <span>Show QR</span>
              </button>
              <button
                onClick={() => {
                ...
                className="h-10 rounded-xl bg-white border border-[#E5E7EB] text-[#021526] font-bold text-[12px] flex items-center justify-center gap-1.5 hover:border-[#021526] active-press transition-all cursor-pointer"
              >
                <Banknote className="w-3.5 h-3.5 text-[#5F6368]" />
