...
export const HomeScreen: React.FC = () => {
  ...
  return (
    <div className="pb-8 pt-3 px-4 w-full space-y-4 select-none">
      ...
      <div className="bg-white rounded-[22px] p-4 border border-[#E8E6E1] shadow-xs space-y-3">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <span className="text-[10px] font-bold uppercase tracking-wider text-[#777570] block">
                Today's Activity
              </span>
              <h2 className="text-[14px] font-extrabold text-[#171717] tracking-tight leading-none mt-0.5">
                Hourly Utilization
              </h2>
            </div>
          </div>
          ...
          <div className="text-right">
            <span className="text-[11px] font-bold text-[#2FA66A] bg-[#2FA66A]/10 px-2 py-0.5 rounded-full inline-flex items-center gap-0.5">
        ...
        {selectedBarIdx !== null && (
          <div className="bg-[#FAF9F6] border border-[#E8E6E1] rounded-xl px-3 py-2 flex items-center justify-between text-[11.5px]">
            <div className="flex items-center gap-1.5 text-[#777570]">
              <span className="font-bold text-[#171717]">{hourlyData[selectedBarIdx].time} Slot</span>
              <span>·</span>
              <span>{hourlyData[selectedBarIdx].bookings} Bookings</span>
            </div>
            <span className="font-extrabold text-[#FF6B2C] text-[12px]">
        ...
        <div className="pt-1">
                ...
                >
                  ...
                  <div
                    ...
                    className={`w-full rounded-t-md transition-all duration-200 ${
                      isSelected
                        ? 'bg-[#FF6B2C] shadow-sm ring-2 ring-[#FF6B2C]/30'
                        : item.isPeak
          ...
          <div className="flex items-center justify-between text-[10px] text-[#777570] font-medium pt-2 border-t border-[#F1F0EC]">
            <div className="flex items-center gap-3">
              <span className="flex items-center gap-1">
                <span className="w-2 h-2 rounded-xs bg-[#FF6B2C]" />
                <span className="font-medium text-[#171717]">Peak (6–10 PM)</span>
              </span>
              <span className="flex items-center gap-1">
                <span className="w-2 h-2 rounded-xs bg-[#E8E6E1]" />
                <span>Regular</span>
              </span>
            </div>
      ...
      <div className="overflow-x-auto no-scrollbar -mx-4 px-4 flex gap-2.5">
        {kpis.map((kpi) => (
          <div
            key={kpi.id}
            className="shrink-0 w-[142px] bg-white rounded-2xl p-3.5 border border-[#E8E6E1] shadow-xs flex flex-col justify-between"
          >
            <span className="text-[10.5px] font-bold uppercase tracking-wider text-[#777570]">
              {kpi.label}
            </span>
            <div className="mt-1 flex items-baseline justify-between">
              <p className="text-[20px] font-extrabold text-[#171717] tracking-tight">
                {kpi.value}
              </p>
              <span
      ...
      <div className="space-y-2.5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-[15px] font-bold text-[#171717]">Action Required</h2>
          </div>
          <button
            onClick={() => {
              haptics.tap();
        ...
        >
          <div className="flex items-start justify-between">
            <div className="space-y-1">
              ...
              <h3 className="text-[14.5px] font-bold text-[#171717]">Rahul Kumar</h3>
              <p className="text-[11.5px] text-[#777570]">
                7:00–8:00 PM · <strong className="text-[#171717]">₹1,200 pending</strong>
              </p>
            </div>
            <button
      ...
      <div className="space-y-2.5">
        <div className="flex items-center justify-between">
          <h2 className="text-[15px] font-bold text-[#171717]">Today's Schedule</h2>
          <button
            onClick={() => {
              haptics.tap();
              navigateTo('slots');
