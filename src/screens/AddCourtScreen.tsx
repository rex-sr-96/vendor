    ...
    <div className="pb-32 pt-3 px-4 w-full max-w-md mx-auto space-y-4">
      ...
      <div className="flex items-center justify-between pt-1">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-[20px] font-bold text-[#171717] leading-tight">Add New Court</h1>
            <p className="text-[11px] text-[#777570]">Configure court specs, pricing & peak schedules</p>
          </div>
        </div>

        <div className="w-8 h-8 rounded-full bg-[#FF6B2C]/10 text-[#FF6B2C] flex items-center justify-center font-bold text-[12px]">
      ...
      <form onSubmit={handleSaveCourt} className="space-y-4 pt-1">
        ...
        <div className="bg-white p-4 rounded-2xl border border-[#E8E6E1] shadow-2xs space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1.5">
              <span className="w-5 h-5 rounded-full bg-[#171717] text-white text-[11px] font-bold flex items-center justify-center">
                1
              </span>
              <label className="text-[13.5px] font-bold text-[#171717]">
                Same physical sports for this turf?
              </label>
            </div>
            <span className="text-[10px] text-[#FF6B2C] bg-[#FF6B2C]/10 font-bold px-2 py-0.5 rounded-full">
              Required
            </span>
          </div>

          <p className="text-[11.5px] text-[#777570] leading-relaxed">
            Select <span className="font-bold text-[#171717]">Yes</span> if this court maps to an existing shared physical ground layout with standard rates.
          </p>
          ...
          <div className="grid grid-cols-2 gap-2.5 pt-1">
            <button
              ...
              className={`py-3 px-3.5 rounded-xl font-bold text-[13px] flex items-center justify-center gap-2 transition-all border cursor-pointer ${
                isSamePhysicalSports === 'yes'
                  ? 'bg-[#171717] text-white border-transparent shadow-xs'
                  : 'bg-[#FAF9F6] text-[#777570] border-[#E8E6E1] hover:border-[#171717]/30'
              }`}
            >
              {isSamePhysicalSports === 'yes' && <Check className="w-4 h-4 text-[#2FA66A]" />}
              <span>Yes</span>
            </button>
            ...
            >
              {isSamePhysicalSports === 'no' && <Check className="w-4 h-4 text-[#2FA66A]" />}
              <span>No</span>
            </button>
          </div>
        </div>
        ...
        {/* ========================================================================= */}
        <div className="bg-white p-4 rounded-2xl border border-[#E8E6E1] shadow-2xs space-y-3.5">
          <div className="flex items-center gap-1.5">
            <span className="w-5 h-5 rounded-full bg-[#171717] text-white text-[11px] font-bold flex items-center justify-center">
              2
            </span>
            <h3 className="text-[13.5px] font-bold text-[#171717]">Court Information</h3>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className="w-full bg-[#FAF9F6] border border-[#E8E6E1] rounded-[14px] px-3.5 py-2.5 text-[14px] font-semibold text-[#171717] focus:outline-none focus:border-[#171717] appearance-none cursor-pointer pr-10"
              >
              ...
              <ChevronDown className="w-4 h-4 text-[#777570] absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none" />
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#FAF9F6] border border-[#E8E6E1] rounded-[14px] px-3.5 py-2.5 text-[14px] font-semibold text-[#171717] focus:outline-none focus:border-[#171717]"
            />
          </div>
          ...
          <div>
            <label className="block text-[12px] font-bold text-[#171717] mb-1">
              Display Name <span className="text-[10.5px] font-normal text-[#777570]">(Customer-Facing)</span>
            </label>
            <input
              type="text"
              value={displayName}
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white p-4 rounded-2xl border border-[#E8E6E1] shadow-2xs space-y-3.5">
              <div className="flex items-center gap-1.5">
                ...
                <h3 className="text-[13.5px] font-bold text-[#171717]">Base Duration & Rate</h3>
              </div>
              ...
              <div>
                <label className="block text-[12px] font-bold text-[#171717] mb-1">
                  Regular Booking Price (₹/hour) <span className="text-[#FF6B2C]">*</span>
                </label>
                <div className="relative flex items-center">
                  <span className="absolute left-3.5 text-[#777570] font-bold text-[14px]">₹</span>
                  <input
                    type="number"
                    required
                    value={regularPrice}
                    ...
                    placeholder="1000"
                    className="w-full bg-[#FAF9F6] border border-[#E8E6E1] rounded-[14px] pl-8 pr-3.5 py-2.5 text-[14px] font-bold text-[#171717] focus:outline-none focus:border-[#171717]"
                  />
                </div>
              </div>
            </div>
            ...
            {/* ========================================================================= */}
            <div className="bg-white p-4 rounded-2xl border border-[#FF6B2C]/30 shadow-2xs space-y-3.5">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-7 h-7 rounded-xl bg-[#FF6B2C]/10 text-[#FF6B2C] flex items-center justify-center">
                    <Flame className="w-4 h-4" />
                  </div>
                  <div>
                    <h3 className="text-[13.5px] font-bold text-[#171717]">Peak Hours</h3>
                    <p className="text-[10.5px] text-[#777570]">Configure high-demand slot timings</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-2.5">
                <div className="bg-[#FAF9F6] p-2.5 rounded-xl border border-[#E8E6E1]">
                  <span className="text-[10px] font-bold text-[#777570] block mb-1">
                    START TIME
                  </span>
                  <select
                    value={peakHoursStart}
                    onChange={(e) => setPeakHoursStart(e.target.value)}
                    className="w-full bg-white border border-[#E8E6E1] rounded-lg px-2 py-1.5 text-[12.5px] font-bold text-[#171717] focus:outline-none cursor-pointer"
                  >
                    {TIME_SLOTS.map((slot) => (
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  <span className="absolute left-3.5 text-[#FF6B2C] font-bold text-[14px]">₹</span>
                  <input
                    type="number"
                    value={peakHoursPrice}
                    onChange={(e) => setPeakHoursPrice(e.target.value)}
                    placeholder="1400"
                    className="w-full bg-[#FAF9F6] border border-[#E8E6E1] rounded-[14px] pl-8 pr-3.5 py-2.5 text-[14px] font-bold text-[#171717] focus:outline-none focus:border-[#FF6B2C]"
                  />
                </div>
                <p className="text-[10.5px] text-[#777570] mt-1">
            ...
            {/* ========================================================================= */}
            <div className="bg-white p-4 rounded-2xl border border-[#2FA66A]/30 shadow-2xs space-y-3.5">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-7 h-7 rounded-xl bg-[#2FA66A]/10 text-[#2FA66A] flex items-center justify-center">
                    <Calendar className="w-4 h-4" />
                  </div>
                  <div>
                    <h3 className="text-[13.5px] font-bold text-[#171717]">Peak Days</h3>
                    <p className="text-[10.5px] text-[#777570]">Select days subject to peak slot pricing</p>
                  </div>
                </div>
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className="text-[10.5px] font-bold text-[#1E774A] bg-[#2FA66A]/10 px-2 py-0.5 rounded hover:bg-[#2FA66A]/20 cursor-pointer"
                  >
                    Fri–Sun
                  </button>
                  <button
                    ...
                    className="text-[10.5px] font-bold text-[#171717] bg-[#FAF9F6] border border-[#E8E6E1] px-2 py-0.5 rounded hover:bg-[#E8E6E1] cursor-pointer"
                  >
                    All
                  </button>
                </div>
                  ...
                  return (
                    <button
                      ...
                      className={`h-10 rounded-xl text-[12px] font-bold transition-all border cursor-pointer flex flex-col items-center justify-center ${
                        isDaySelected
                          ? 'bg-[#171717] text-white border-transparent shadow-2xs'
                          : 'bg-[#FAF9F6] text-[#777570] border-[#E8E6E1]'
                      }`}
                    >
                      <span>{d}</span>
                      {isDaySelected && <div className="w-1.5 h-1.5 rounded-full bg-[#2FA66A] mt-0.5" />}
                    </button>
                  );
                })}
              </div>

              <div className="bg-[#FAF9F6] p-2.5 rounded-xl border border-[#E8E6E1] flex items-center justify-between text-[11px]">
                <span className="text-[#777570]">Active Peak Days:</span>
            ...
            <div className="bg-white p-4 rounded-2xl border border-[#E8E6E1] shadow-2xs space-y-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-xl bg-[#E7A72F]/15 text-[#B87C0D] flex items-center justify-center">
                  <Sun className="w-4 h-4" />
                </div>
                <div>
                  <h3 className="text-[13.5px] font-bold text-[#171717]">Weekend Price (Saturday & Sunday)</h3>
                  <p className="text-[10.5px] text-[#777570]">All-day weekend flat hourly rate</p>
                </div>
              </div>
        ...
        <div className="pt-2">
          <button
            ...
            className="w-full h-12 bg-[#FF6B2C] text-white font-bold text-[14.5px] rounded-xl flex items-center justify-center gap-2 shadow-xs hover:bg-[#e85b1e] active-press cursor-pointer"
          >
