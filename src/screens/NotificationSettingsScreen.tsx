      ...
      <div className="bg-white rounded-2xl border border-[#E8E6E1] shadow-xs overflow-hidden">
        ...
        <div className="divide-y divide-[#F1F0EC]">
          ...
          <div
            ...
            className="p-3.5 flex items-center justify-between hover:bg-[#F7F7F5] cursor-pointer"
          >
            <div className="pr-3">
              <h3 className="text-[13px] font-bold text-[#171717]">Booking Confirmations</h3>
            ...
            <div
              className={`w-11 h-6 rounded-full transition-colors relative shrink-0 ${
                prefs.whatsappBookingConfirmation ? 'bg-[#FF6B2C]' : 'bg-[#E8E6E1]'
              }`}
            >
              <div
          ...
          >
            <div className="pr-3">
              <h3 className="text-[13px] font-bold text-[#171717]">Payment Links & Balance Due</h3>
              <p className="text-[11px] text-[#777570]">
            ...
            <div
              className={`w-11 h-6 rounded-full transition-colors relative shrink-0 ${
                prefs.whatsappPaymentReminder ? 'bg-[#FF6B2C]' : 'bg-[#E8E6E1]'
              }`}
            >
              <div
                className={`w-5 h-5 rounded-full bg-white shadow-xs absolute top-0.5 transition-transform ${
