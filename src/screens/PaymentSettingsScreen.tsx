  ...
  return (
    <div className="pb-28 pt-4 px-4 max-w-md mx-auto space-y-5">
      ...
      <div className="flex items-center gap-2 pt-2">
        ...
        <h1 className="text-[22px] font-bold text-[#171717]">Payment Settings</h1>
      </div>
      ...
      <div className="bg-[#171717] text-white rounded-3xl p-5 shadow-sm space-y-4">
        ...
        <div className="text-[12px] text-[#A3A099] flex justify-between pt-1 border-t border-white/10">
      ...
      <div className="bg-white rounded-2xl border border-[#E8E6E1] shadow-xs divide-y divide-[#F1F0EC] overflow-hidden">
        ...
        <div className="p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-[14px] font-bold text-[#171717]">Online Payments (UPI/Cards)</h3>
              <p className="text-[12px] text-[#777570]">Collect via links and dynamic QR</p>
            </div>
          </div>
          ...
          <button
            ...
            className={`w-11 h-6 rounded-full transition-colors relative p-0.5 ${
              paymentSettings.onlinePayment ? 'bg-[#FF6B2C]' : 'bg-[#E8E6E1]'
            }`}
          >
            <div
        ...
        <div className="p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-[#171717]/10 text-[#171717] flex items-center justify-center">
              <Banknote className="w-4.5 h-4.5" />
            </div>
            <div>
              <h3 className="text-[14px] font-bold text-[#171717]">Cash Payment at Venue</h3>
              <p className="text-[12px] text-[#777570]">Allow on-site physical cash collection</p>
            </div>
          </div>
          ...
          <button
            ...
            className={`w-11 h-6 rounded-full transition-colors relative p-0.5 ${
              paymentSettings.cashPayment ? 'bg-[#FF6B2C]' : 'bg-[#E8E6E1]'
            }`}
          >
            <div
              className={`w-5 h-5 rounded-full bg-white shadow-xs transition-transform ${
      ...
      {showBankModal && (
        <div className="absolute inset-0 z-50 flex items-end justify-center bg-black/60 backdrop-blur-xs">
          <div className="w-full bg-white rounded-t-[32px] p-5 pb-8 shadow-2xl border-t border-[#E8E6E1] space-y-4 animate-in slide-in-from-bottom-6 duration-200">
            {/* iOS Grab Handle */}
            ...
            <div className="flex items-center justify-between pb-2 border-b border-[#F1F0EC]">
              <div>
                <h2 className="text-[17px] font-extrabold text-[#171717] tracking-tight">Update Bank Account</h2>
                <p className="text-[11.5px] text-[#777570]">Direct verified settlement payout account</p>
              </div>
              <button
                type="button"
            ...
            <form onSubmit={handleSaveBank} className="space-y-3">
              <div>
                <label className="block text-[11.5px] font-bold text-[#171717] mb-1">Bank Name</label>
                <input
                  type="text"
                  required
                  ...
                  className="w-full bg-[#F7F7F5] border border-[#E8E6E1] rounded-xl px-3.5 py-2 text-[13.5px] font-bold text-[#171717] focus:outline-none focus:border-[#FF6B2C]"
                />
              </div>

              <div>
                <label className="block text-[11.5px] font-bold text-[#171717] mb-1">Account Number</label>
                <input
                  type="text"
                  required
                  ...
                  className="w-full bg-[#F7F7F5] border border-[#E8E6E1] rounded-xl px-3.5 py-2 text-[13.5px] font-bold font-mono text-[#171717] focus:outline-none focus:border-[#FF6B2C]"
                />
              </div>

              <div>
                <label className="block text-[11.5px] font-bold text-[#171717] mb-1">IFSC Code</label>
                <input
                  type="text"
                  required
                  ...
                  className="w-full bg-[#F7F7F5] border border-[#E8E6E1] rounded-xl px-3.5 py-2 text-[13.5px] font-bold font-mono uppercase text-[#171717] focus:outline-none focus:border-[#FF6B2C]"
                />
              </div>
              ...
              <div className="pt-2 flex gap-2">
                <button
                  type="button"
                  onClick={() => setShowBankModal(false)}
                  className="flex-1 h-11 bg-[#F1F0EC] text-[#171717] font-bold rounded-xl active-press text-[13px] cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="flex-1 h-11 bg-[#FF6B2C] text-white font-bold rounded-xl active-press shadow-xs text-[13px] hover:bg-[#e85b1e] cursor-pointer"
                >
                  Verify & Link
                </button>
              </div>
