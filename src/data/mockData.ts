...
export const initialAmenities: AmenityItem[] = [
  ...
  },
  {
    ...
    enabled: true,
    price: 0,
    description: 'Sports snack bar, cold drinks, energy bars, and hydration lounge',
    iconName: 'Coffee',
    icon: 'Coffee',
  ...
  },
  {
    ...
    enabled: true,
    price: 100,
    description: 'Match footballs, cricket bats, badminton racquets, and bibs',
  ...
  },
  {
    ...
    enabled: true,
    price: 0,
    description: 'Covered tiered seating stands and dugouts for viewers and squads',
    iconName: 'Armchair',
    icon: 'Armchair',
